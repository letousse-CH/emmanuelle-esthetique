 ...
 */
export default function NewSocialPostDialog({ onClose, onCreated }: Props) {
      ...
      >
        ...
        <form onSubmit={submit} className="p-6 space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="new-post-title" className="block text-xs font-semibold uppercase tracking-widest text-stone-500">
              Titre / sujet
            </label>
            <input
              id="new-post-title"
              ...
              className="w-full px-3 py-2.5 border border-stone-200 rounded-xl text-sm outline-none focus:border-sage bg-stone-50 focus:bg-white transition-colors disabled:opacity-60"
            />
          </div>

          <div className="space-y-1.5">
            <label htmlFor="new-post-brief" className="block text-xs font-semibold uppercase tracking-widest text-stone-500">
              Angle / brief
            </label>
            <textarea
              id="new-post-brief"
              ...
              className="w-full px-3 py-2.5 border border-stone-200 rounded-xl text-sm outline-none focus:border-sage bg-stone-50 focus:bg-white transition-colors resize-none leading-relaxed disabled:opacity-60"
            />
            <p className="text-[11px] text-stone-400">Plus le brief est précis, moins le résultat aura besoin d'être retouché.</p>
          </div>

          <div className="space-y-1.5">
            <label htmlFor="new-post-date" className="block text-xs font-semibold uppercase tracking-widest text-stone-500">
              Planifier le
            </label>
            <input
              id="new-post-date"
              ...
              disabled={busy}
              className="px-3 py-2.5 border border-stone-200 rounded-xl text-sm outline-none focus:border-sage bg-stone-50 focus:bg-white transition-colors disabled:opacity-60"
            />
          </div>
          ...
          {busy && <p className="text-[11px] text-stone-400 text-center">L'IA écrit les 3 formats — comptez une dizaine de secondes.</p>}
        </form>
      </div>
    </div>
  );
