...
import InlinePageEditor from '../../../../components/pagebuilder/InlinePageEditor';
  ...
  if (!page) {
        ...
        <>
          ...
          {isAdmin && (
            <button
              ...
              disabled={creating}
              className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-stone-900 text-white px-5 py-3 rounded-full shadow-2xl text-sm font-bold hover:bg-sage transition-colors duration-300 disabled:opacity-50 cursor-pointer"
            >
              {creating ? (
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-stone-500 gap-4">
        ...
        <Link href="/" className="text-sage hover:underline text-sm">← Retour à l'accueil</Link>
      </div>
    );
  }
