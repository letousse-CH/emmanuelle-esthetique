...
export const SECTION_DEFAULTS: Record<SectionType, Record<string, unknown>> = {
  ...
  marquee_1: { items: ['Reprendre le contrôle', 'Briser l\'emprise', 'Reconquérir sa liberté', 'Avancer enfin'], bg_color: '#0f0e0d', text_color: '#d4b483', separator: '★', speed: 'normal' },
  ...
  reviews_1: { title: 'Les avis de', title_bold: 'nos clients', description: 'Découvrez les résultats concrets de nos accompagnés', cta_text: 'Voir plus de témoignages', cta_href: '#', cards: [{ name: 'Marie D.', date: 'il y a 2 mois', rating: 5, text: 'Un accompagnement exceptionnel qui a transformé ma vie. Je recommande vivement.' }, { name: 'Sophie L.', date: 'il y a 3 mois', rating: 5, text: 'Programme incroyable, j\'ai enfin pu avancer et reprendre confiance en moi.' }, { name: 'Julie M.', date: 'il y a 4 mois', rating: 5, text: 'Matthieu est un coach bienveillant et très professionnel. Merci infiniment !' }] },
